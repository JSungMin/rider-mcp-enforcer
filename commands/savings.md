---
description: Report how many tokens the rider-mcp-enforcer plugin has saved (vs forwarding Rider's raw responses), plus build-artifact noise items dropped.
---
